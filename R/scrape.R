...
m_scrape <- function(bow, params=NULL, accept="html", content=NULL, verbose=FALSE) { # nolint
  ...
  res <- tryCatch(
    ...
    error=function(cond){
      ...
      message(cond); cat("\n")
      cat(green("     ","But, please, do not dispair! I will return a raw vector to you now,\n"), sep="")
...
#' @param content MIME type (aka internet media type) used to override the content type returned by the server. See http://en.wikipedia.org/wiki/Internet_media_type for a list of common types.
