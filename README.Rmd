...
The backend functionality of `polite` can be used for *any* function as long as it has `url` argument. Here's an example of polite POST created with adverb `politely`.
